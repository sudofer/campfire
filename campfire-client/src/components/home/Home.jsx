...
export default function Home() {
  ...
  const handleSubmit = () => {
    if (url && name) {
      ...
      alert("Must have a valid name and URL!");
    }
    handleClose();
  };
      ...
      <div id="frontPageContainer">
        <div class="video-background">
          <div class="video-foreground">
            <iframe
              title="intentionally_blank"
              aria-hidden="true"
              src="https://www.youtube.com/embed/NUKKzdVy0EI?controls=0&showinfo=0&rel=0&autoplay=1&loop=1&playlist=NUKKzdVy0EI&mute=1"
              allow="autoplay"
              volume="0"
              frameborder="0"
              allowfullscreen
              ...
              <Grid item xs={12} sm={4}>
                <div className={classes.card}>
                  ...
                  <Typography className={classes.featureList}>
                    Create a new campfire for you and your friends, then share
                    the link
                  </Typography>
                </div>
              </Grid>
